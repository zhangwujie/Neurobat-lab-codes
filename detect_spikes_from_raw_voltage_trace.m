...
voltage_trace_data_folder='D:\Wujie\Analysis\19 Debugging and testing Nlg2Nlx code, 160629\test exports and imports\'; % the folder where the voltage traces are saved (as AD counts in .mat files as outputs of extract_Nlg_data.m)
output_folder='D:\Wujie\Analysis\19 Debugging and testing Nlg2Nlx code, 160629\test exports and imports\'; % the folder where the outputs of the code (time stamps and waveforms of potential spikes, in the Nlx .ntt format) will be saved
output_spike_file_name_prefix=''; % the output file names will be this prefix followed by "TT#.ntt" where "#" is the tetrode number; can leave as an empty string
